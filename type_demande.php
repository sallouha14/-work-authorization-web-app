...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $type = $_POST['type'];
    header("Location: demande.php?type=" . urlencode($type));
    exit();
}
?>
...
<div class="container" role="main" aria-label="Choisir le type de demande">
  <div class="title">Choisir le type de demande</div>
  <form method="post" novalidate>
    <button class="btn" type="submit" name="type" value="entrée">Demande d'entrée</button>
    <button class="btn" type="submit" name="type" value="sortie">Demande de sortie</button>
  </form>
</div>
